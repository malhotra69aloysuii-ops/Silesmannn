...
class StripeCharge50Checker(BaseCCChecker):
    ...
    def process_card(self, card_line: str) -> Optional[Dict]:
        ...
        if not self.session_created or self.fluentform_nonce is None:
...
class CCBot:
    ...
    async def deduct_credits_for_hit(self, user_id: int, status: str, mode: str) -> bool:
        if status == "𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗":
            if UserDatabase.is_admin(user_id):
                return True
    ...
    async def add_credits_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if len(context.args) != 2:
            await update.message.reply_text(
                "💰 *𝗨𝘀𝗮𝗴𝗲:* `/𝗮𝗱𝗱𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘀 <𝘂𝘀𝗲𝗿_𝗶𝗱> <𝗮𝗺𝗼𝘂𝗻𝘁>`\n\n"
                "𝗘𝘅𝗮𝗺𝗽𝗹𝗲: `/𝗮𝗱𝗱𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘀 𝟭𝟮𝟯𝟰𝟱𝟲𝟳𝟴𝟵 𝟭𝟬𝟬`",
                parse_mode=ParseMode.MARKDOWN
            )
            return
    ...
    async def users_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        summary_text = (
            ...
            f"💰 *𝗧𝗼𝘁𝗮𝗹 𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘀 𝗶𝗻 𝗦𝘆𝘀𝘁𝗲𝗺:* `{total_credits}`\n\n"
            f"{users_text}"
        )
    ...
    async def send_trx_id_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            ...
            "𝗬𝗼𝘂𝗿 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 𝘄𝗶𝗹𝗹 𝗯𝗲 𝗮𝗱𝗱𝗲𝗱 𝘀𝗼𝗼𝗻.\n\n"
            "📧 *𝗔𝗱𝗺𝗶𝗻:* @𝗠𝗱𝗦𝗮𝗺𝗶𝗿𝟮𝟬𝟬𝟬",
            parse_mode=ParseMode.MARKDOWN
        )
    ...
    async def process_file(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            if not is_admin and user_credits <= 0 and user_free_checks <= 0:
                await update.message.reply_text(
                    "❌ *𝗜𝗻𝘀𝘂𝗳𝗳𝗶𝗰𝗶𝗲𝗻𝘁 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀!*\n\n"
                    f"𝗬𝗼𝘂 𝗵𝗮𝘃𝗲 `{user_credits}` 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 𝗮𝗻𝗱 `{user_free_checks}` 𝗳𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸𝘀.\n"
                    "𝗬𝗼𝘂 𝗻𝗲𝗲𝗱 𝗮𝘁 𝗹𝗲𝗮𝘀𝘁 𝟭 𝗰𝗿𝗲𝗱𝗶𝘁 𝗼𝗿 𝗳𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸 𝘁𝗼 𝗰𝗵𝗲𝗰𝗸 𝗰𝗮𝗿𝗱𝘀.\n\n"
                    "𝗨𝘀𝗲 /𝗯𝘂𝘆𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 𝘁𝗼 𝗽𝘂𝗿𝗰𝗵𝗮𝘀𝗲 𝗺𝗼𝗿𝗲 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘀.",
                    parse_mode=ParseMode.MARKDOWN
                )
                return
    ...
    async def handle_text(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if '|' in text and len(text) > 10:
            ...
            await update.message.reply_text(
                ...
                "• 𝗦𝗵𝗼𝘄 𝘆𝗼𝘂𝗿 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 𝗮𝗻𝗱 𝘀𝘁𝗮𝘁𝘀\n"
                "• 𝗛𝗲𝗹𝗽 𝘆𝗼𝘂 𝗯𝘂𝘆 𝗺𝗼𝗿𝗲 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘀\n\n"
                "📝 *𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀:*\n"
                "• /𝘀𝘁𝗮𝗿𝘁 - 𝗦𝘁𝗮𝗿𝘁 𝘁𝗵𝗲 𝗯𝗼𝘁\n"
                "• /𝗵𝗲𝗹𝗽 - 𝗦𝗵𝗼𝘄 𝗵𝗲𝗹𝗽\n"
                "• /𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 - 𝗖𝗵𝗲𝗰𝗸 𝘆𝗼𝘂𝗿 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘀\n"
                "• /𝗯𝘂𝘆𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 - 𝗕𝘂𝘆 𝗺𝗼𝗿𝗲 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘭𝘀",
                parse_mode=ParseMode.MARKDOWN
            )
...
💳 *𝗬𝗼𝘂𝗿 𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀:* `{credits}`{free_checks_msg}
...
"""
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("💳 𝗖𝗛𝗘𝗖𝗞 𝗖𝗥𝗘𝗗𝗶𝗧𝗦", callback_data="check_credits"),
             InlineKeyboardButton("📊 𝗨𝗦𝗘𝗥 𝗦𝗧𝗔𝗧𝗦", callback_data="user_stats")],
            [InlineKeyboardButton("🛒 𝗕𝗨𝗬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦", callback_data="buy_credits")] if not is_admin else [],
...
💰 *𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀:* `{credits}`{admin_msg}{free_checks_msg}
...
𝗦𝗲𝗹𝗲𝗰𝘁 𝗮 𝗺𝗼𝗱𝗲 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝘀𝘁𝗮𝗿𝘁!
        ...
        keyboard = [
            [InlineKeyboardButton("🔒 𝗦??𝗥𝗜𝗣𝗘 𝗔𝗨𝗧𝗛 𝗠𝗢𝗗𝗘", callback_data="mode_auth")],
            [InlineKeyboardButton("💰 𝗦𝗧𝗥𝗜𝗣𝗘 𝗖𝗛𝗔𝗥𝗚𝗘 $𝟭 𝗠𝗢𝗗𝗘", callback_data="mode_charge")],
            [InlineKeyboardButton("💵 𝗦𝗧𝗥𝗜𝗣𝗘 𝗖𝗛𝗔𝗥𝗚𝗘 $𝟬.𝟱𝟬 𝗠𝗢𝗗𝗘", callback_data="mode_charge50")],
            [InlineKeyboardButton("🛒 𝗕𝗨𝗬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦", callback_data="buy_credits")] if not is_admin else [],
...
💰 *𝗙𝗶𝗻𝗮𝗻𝗰𝗶𝗮𝗹:*
• 💳 *𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀:* `{credits}`{admin_msg}{free_checks_msg}
📈 *𝗣𝗲𝗿𝗳𝗼𝗿𝗺𝗮𝗻𝗰𝗲:*
• 📊 *𝗧𝗼𝘁𝗮𝗹 𝗖𝗮𝗿𝗱𝘀 𝗖𝗵𝗲𝗰𝗸𝗲𝗱:* `{total_checked}`
• 🔥 *𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗 𝗖𝗮𝗿𝗱𝘀:* `{approved}`
• ✅ *𝗖𝗩𝗩 𝗖𝗮𝗿𝗱𝘀:* `{cvv}`
...
• 🔄 *𝗔𝘃𝗲𝗿𝗮𝗴𝗲 𝗰𝗮𝗿𝗱𝘀/𝘀𝗲𝘀𝘀𝗶𝗼𝗻:* `{total_checked/sessions if sessions > 0 else 0:.1f}`
        ...
        keyboard = [
            [InlineKeyboardButton("🔒 𝗦𝗧𝗥𝗜𝗣𝗘 𝗔𝗨𝗧𝗛 𝗠𝗢𝗗𝗘", callback_data="mode_auth")],
            [InlineKeyboardButton("💰 𝗦𝗧𝗥𝗜𝗣𝗘 𝗖𝗛𝗔𝗥𝗚𝗘 $𝟭 𝗠𝗢𝗗𝗘", callback_data="mode_charge")],
            [InlineKeyboardButton("💵 𝗦𝗧𝗥𝗜𝗣𝗘 𝗖𝗖𝗛𝗔𝗥𝗚𝗘 $𝟬.𝟱𝟬 𝗠𝗢𝗗𝗘", callback_data="mode_charge50")],
            [InlineKeyboardButton("🛒 𝗕𝗨𝗬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦", callback_data="buy_credits")] if not is_admin else [],
            [InlineKeyboardButton("⬅️ 𝗕𝗔𝗖𝗞", callback_data="back_to_menu")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
• 🔒 *𝗔𝗹𝗹 𝗠𝗼𝗱𝗲𝘀:* 𝟭 𝗰𝗿𝗲𝗱𝗶𝘁 𝗳𝗼𝗿 𝗲𝗮𝗰𝗵 𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗 𝗰𝗮𝗿𝗱
• 🚫 *𝗡𝗢 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘀 𝗱𝗲𝗱𝘂𝗰𝘁𝗲𝗱 𝗳𝗼𝗿:* DECLINED, CVV, CCN, LOW FUNDS, ERROR
        
💰 *𝗛𝗼𝘄 𝘁𝗼 𝗴𝗲𝘁 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴:*
• 𝗨𝘀𝗲 /𝗯𝘂𝘆𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 𝘁𝗼 𝘀𝗲𝗲 𝗽𝗮𝗰𝗸𝗮𝗴𝗲𝘀
• 𝗦𝗲𝗻𝗱 𝗽𝗮𝘆𝗺𝗲𝗻𝘁 𝘁𝗼 𝘁𝗵𝗲 𝗮𝗱𝗱𝗿𝗲𝘀𝘀𝗲𝘀
• 𝗦𝗲𝗻𝗱 𝗧𝗿𝗮𝗻𝘀𝗮𝗰𝘁𝗶𝗼𝗻 𝗜𝗗 𝘁𝗼 @𝗠𝗱𝗦𝗮𝗺𝗶𝗿𝟮𝟬𝟬𝟬
        
🎁 *𝗙𝗥𝗘𝗘 𝗖𝗛𝗘𝗖𝗞𝗦:*
• 𝗙𝗶𝗿𝘀𝘁 𝗿𝗲𝗴𝘂𝗹𝗮𝗿 𝘂𝘀𝗲𝗿 𝗴𝗲𝘁𝘀 𝟭𝟬𝟬 𝗳𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸𝘀!
• 𝗙𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸𝘀 𝗮𝗿𝗲 𝘂𝘀𝗲𝗱 𝗳𝗶𝗿𝘀𝘁 𝗯𝗲𝗳𝗼𝗿𝗲 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘭𝘴
...
📤 *𝗦𝗲𝗻𝗱 𝗮 𝗧𝗫𝗧 𝗳𝗶𝗹𝗲 𝗮𝗳𝘁𝗲𝗿 𝘀𝗲𝗹𝗲𝗰𝘁𝗶𝗻𝗴 𝗺𝗼𝗱𝗲!*
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("💵 𝗦𝗘𝗟𝗘𝗖𝗧 𝗦𝗧𝗥𝗜𝗣𝗘 𝗖𝗖𝗛𝗔𝗥𝗚𝗘 $𝟬.𝟱𝟬", callback_data="mode_charge50")],
            [InlineKeyboardButton("💳 𝗖𝗛𝗘𝗖𝗞 𝗖𝗥𝗘𝗗𝗶𝗧𝗦", callback_data="check_credits")],
            [InlineKeyboardButton("⬅️ 𝗕𝗔𝗖𝗞", callback_data="back_to_menu")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
• 💰 𝗧𝗼𝘁𝗮𝗹 𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 𝗶𝗻 𝗦𝘆𝘀𝘁𝗲𝗺: `{total_credits}`
...
🔧 *𝗔𝗗𝗠𝗜𝗡 𝗔𝗖𝗧𝗜𝗢𝗡𝗦:*
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("💰 𝗔𝗗𝗗 𝗖𝗥𝗘𝗗𝗶𝗧𝗦", callback_data="admin_add_credits")],
...
💳 *𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴:* `{credits}`{free_checks_msg}
...
📊 *𝗨𝗦𝗘𝗥 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦:*
• /𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 - 𝗖𝗵𝗲𝗰𝗸 𝘆𝗼𝘂𝗿 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴
• /𝘀𝘁𝗮𝘁𝘀 - 𝗩𝗶𝗲𝘄 𝘆𝗼𝘂𝗿 𝘀𝘁𝗮𝘁𝗶𝘀𝘁𝗶𝗰𝘀
• /𝗯𝘂𝘆𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 - 𝗕𝘂𝘆 𝗺𝗼𝗿𝗲 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴
...
• /𝗮𝗱𝗱𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 <𝗶𝗱> <𝗮𝗺𝗼𝘂𝗻𝘁> - 𝗔𝗱𝗱 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴
• /𝘂𝘀𝗲𝗿𝘀 - 𝗩𝗶𝗲𝘄 𝗮𝗹𝗹 𝘂𝘀𝗲𝗿𝘀
• /𝗱𝗶𝘀𝗮𝗯𝗹𝗲𝘂𝘀𝗲𝗿 <𝗶𝗱> - 𝗗𝗶𝘀𝗮𝗯𝗹𝗲 𝘂𝘀𝗲𝗿
• /𝗲𝗻𝗮𝗯𝗹𝗲𝘂𝘀𝗲𝗿 <𝗶𝗱> - 𝗘𝗻𝗮𝗯𝗹𝗲 𝘂𝘀𝗲𝗿
• /𝗰𝗼𝗺𝗽𝗹𝗲𝘁𝗲𝘁𝗿𝘅 <𝗰𝗼𝗱𝗲> <𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴> - 𝗖𝗼𝗺𝗽𝗹𝗲𝘁𝗲 𝘁𝗿𝗮𝗻𝘀𝗮𝗰𝘁𝗶𝗼𝗻
        ...
        if UserDatabase.is_admin(user_id):
            if update.callback_query:
                await update.callback_query.answer(
                    "*👑 𝗔𝗱𝗺𝗶𝗻 𝗗𝗲𝘁𝗲𝗰𝘁𝗲𝗱!*\n\n"
                    "𝗬𝗼𝘂 𝗵𝗮𝘃𝗲 𝘂𝗻𝗹𝗶𝗺𝗶𝘁𝗲𝗱 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴. 𝗡𝗼 𝗻𝗲𝗲𝗱 𝘁𝗼 𝗯𝘂𝘆! 🚀",
                    show_alert=True
                )
            else:
                await update.message.reply_text(
...
"""
        ...
        keyboard = [
            [InlineKeyboardButton("💰 𝟭𝟬𝟬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦 ($𝟭𝟬)", callback_data="buy_100")],
            [InlineKeyboardButton("💰 𝟱𝟬𝟬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦 ($𝟰𝟬)", callback_data="buy_500")],
            [InlineKeyboardButton("💰 𝟭𝟬𝟬𝟬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦 ($𝟳𝟱)", callback_data="buy_1000")],
            [InlineKeyboardButton("📸 𝗦𝗘𝗡𝗗 𝗧𝗥𝗔𝗡𝗦𝗔𝗖𝗧𝗶𝗢𝗡 𝗜𝗗", callback_data="send_trx")],
            [InlineKeyboardButton("⬅️ 𝗕𝗔𝗖𝗞", callback_data="back_to_menu")]
        ]
...
*💡 𝗖𝗥𝗘𝗗𝗜𝗧 𝗗𝗘𝗗𝗨𝗖𝗧𝗜𝗢𝗡 𝗥𝗨𝗟𝗘𝗦:*
• 𝟭 𝗰𝗿𝗲𝗱𝗶𝘁 𝗼𝗿 𝗳𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸 𝗳𝗼𝗿 𝗲𝗮𝗰𝗵 𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗 𝗰𝗮𝗿𝗱
...
*𝗖𝗹𝗶𝗰𝗸 𝗮𝗻𝘆 𝗯𝘂𝘁𝘁𝗼𝗻 𝗯𝗲𝗹𝗼𝘄 𝗳𝗼𝗿 𝗿𝗲𝗮𝗹-𝘁𝗶𝗺𝗲 𝘀𝘁𝗮𝘁𝘀!*
            ...
            for i, card in enumerate(cards):
                if not session.get('active', True):
                    await msg.edit_text(
                        ...
                        f"*💳 𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 𝘂𝘀𝗲𝗱:* `{stats.get('APPROVED', 0)}`\n\n"
                ...
                status = result['status'].replace("𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗", "APPROVED").replace("𝗖𝗖𝗡", "CCN").replace("𝗖𝗩𝗩", "CVV").replace("𝗗𝗘𝗖𝗟𝗜𝗡𝗘𝗗", "DECLINED").replace("𝗜𝗡𝗦𝗨𝗙𝗙𝗜𝗖𝗜𝗘𝗡𝗧 𝗙𝗨𝗡𝗗𝗦", "INSUFFICIENT_FUNDS").replace("𝟯𝗗 𝗟𝗜𝗩𝗘", "3D_LIVE").replace("𝗦𝗧𝗥𝗜𝗣𝗘 𝗔𝗨𝗧𝗛", "STRIPE_AUTH").replace("𝗘𝗥𝗥𝗢𝗥", "ERROR").replace("𝗨𝗡𝗞𝗡𝗢𝗪𝗡", "UNKNOWN")
                ...
                if "APPROVED" in status:
                    ...
                    if (user_credits > 0 or user_free_checks > 0) or UserDatabase.is_admin(user_id):
                        success = await self.deduct_credits_for_hit(user_id, result['status'], mode)
                        if success and not UserDatabase.is_admin(user_id):
                            if user_free_checks > 0:
                                user_free_checks -= 1
                                session['user_free_checks'] = user_free_checks
                            else:
                                user_credits -= 1
                ...
                message_text = await self.create_status_message(result, stats, current, total, mode, user_credits, user_free_checks)
                
                try:
                    buttons = await self.create_processing_buttons(result, stats, current, total, mode, user_credits, user_free_checks)
                    await msg.edit_text(
                        message_text,
                        parse_mode=ParseMode.MARKDOWN,
                ...
                if user_credits <= 0 and user_free_checks <= 0 and "APPROVED" in status and not UserDatabase.is_admin(user_id):
                    await update.message.reply_text(
                        "⚠️ *𝗬𝗼𝘂 𝗵𝗮𝘃𝗲 𝗿𝘂𝗻 𝗼𝘂𝘁 𝗼𝗳 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 𝗮𝗻𝗱 𝗳𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸𝘀!*\n\n"
                        "𝗣𝗿𝗼𝗰𝗲𝘀𝘀𝗶𝗻𝗴 𝘄𝗶𝗹𝗹 𝗰𝗼𝗻𝘁𝗶𝗻𝘂𝗲 𝗳𝗼𝗿 𝗻𝗼𝗻-𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗 𝗰𝗮𝗿𝗱𝘀, 𝗯𝘂𝘁 𝗻𝗼 𝗺𝗼𝗿𝗲 𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗 𝗰𝗮𝗿𝗱𝘀 𝘄𝗶𝗹𝗹 𝗯𝗲 𝗽𝗿𝗼𝗰𝗲𝘀𝘀𝗲𝗱.\n"
                        "𝗨𝘀𝗲 /𝗯𝘂𝘆𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘭𝘴 𝘁𝗼 𝗽𝘂𝗿𝗰𝗵𝗮𝘀𝗲 𝗺𝗼𝗿𝗲 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘭𝘴.",
                        parse_mode=ParseMode.MARKDOWN
                    )
    ...
    async def create_processing_buttons(self, card_info: Dict, stats: Dict, current: int, total: int, mode: str, user_credits: int, user_free_checks: int) -> InlineKeyboardMarkup:
        ...
        credits_text = f"💳 𝗖𝗥𝗘𝗗𝗶𝗧𝗦: {user_credits}"
        if user_free_checks > 0:
...
*𝗧𝗶𝗺𝗲:* `{current_time}`
*𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴:* `{user_credits}`{free_checks_msg}
...
🔧 *𝗠𝗼𝗱𝗲:* `{mode_text}`
💳 *𝗥𝗲𝗺𝗮𝗶𝗻𝗶𝗻𝗴 𝗖𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴:* `{user_credits}`{free_checks_msg}
📊 *𝗙𝗜𝗡𝗔𝗟 𝗦𝗧𝗔𝗧𝗜𝗦𝗧𝗜𝗖𝗦:*
• *𝗧𝗢𝗧𝗔𝗟 𝗖𝗔𝗥𝗗𝗦:* `{stats['TOTAL']}`
• *𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗:* `{stats.get('APPROVED', 0)}` (𝗨𝘀𝗲𝗱 {stats.get('APPROVED', 0)} 𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴/𝗳𝗿𝗲𝗲 𝗰𝗵𝗲𝗰𝗸𝘀)
...
"""
            ...
            await query.edit_message_text(
                ...
                "📝 *𝗙𝗼𝗿𝗺𝗮𝘁:* `𝗰𝗰𝗻|𝗺𝗺|𝘆𝘆|𝗰𝘃𝘃`\n"
                "📄 *𝗘𝘅𝗮𝗺𝗽𝗹𝗲:* `𝟰𝟮𝟭𝟯𝟳𝟴𝟬𝟬𝟬𝟬𝟬??𝟬𝟬𝟬𝟬|𝟬𝟲|𝟮𝟱|𝟯𝟭𝟳`",
                parse_mode=ParseMode.MARKDOWN
            )
            ...
            await query.edit_message_text(
                "💰 *𝗔𝗗𝗗 𝗖𝗥𝗘𝗗𝗶𝗧𝗦*\n\n"
                "𝗨𝘀𝗲: `/𝗮𝗱𝗱𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 <𝘂𝘀𝗲𝗿_𝗶𝗱> <𝗮𝗺𝗼𝘂𝗻𝘁>`\n\n"
                "𝗘𝘅𝗮𝗺𝗽𝗹𝗲: `/𝗮𝗱𝗱𝗰𝗿𝗲𝗱𝗶𝘁𝘁𝘁𝘭𝘴 𝟭𝟮𝟯𝟰𝟱𝟲𝟳𝟴𝟵 𝟭𝟬𝟬`",
                parse_mode=ParseMode.MARKDOWN
            )
            ...
            await query.edit_message_text(
                "💰 *𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘: 𝟭𝟬𝟬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦 ($𝟭𝟬)*\n\n"
                "𝗣𝗹𝗲𝗮𝘀𝗲 𝘀𝗲𝗻𝗱 $𝟭𝟬 𝘁𝗼 𝗼𝗻𝗲 𝗼𝗳 𝘁𝗵𝗲𝘀𝗲 𝗮𝗱𝗱𝗿𝗲𝘀𝘀𝗲𝘀:\n\n"
            ...
            await query.edit_message_text(
                "💰 *𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘: 𝟱𝟬𝟬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦 ($𝟰𝟬)*\n\n"
                "𝗣𝗹𝗲𝗮𝘀𝗲 𝘀𝗲𝗻𝗱 $𝟰𝟬 𝘁𝗼 𝗼𝗻𝗲 𝗼𝗳 𝘁𝗵𝗲𝘀𝗲 𝗮𝗱𝗱𝗿𝗲𝘀𝘀𝗲𝘀:\n\n"
                f"• *𝗕𝗶𝗻𝗮𝗻𝗰𝗲 𝗜𝗗:* `{self.payment_addresses['Binance ID']}`\n"
                f"• *𝗨𝗦𝗗𝗧 (𝗕𝗡𝗕 𝗦𝗺𝗮𝗿𝘁 𝗖𝗵𝗮𝗶𝗻):* `{self.payment_addresses['USDT (BNB Smart Chain)']}`\n"
                f"• *𝗟𝗧𝗖:* `{self.payment_addresses['LTC']}`\n"
                f"• *𝗕𝗧𝗖:* `{self.payment_addresses['BTC']}`\n\n"
            ...
            await query.edit_message_text(
                "💰 *𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘: 𝟭𝟬𝟬𝟬 𝗖𝗥𝗘𝗗𝗶𝗧𝗦 ($𝟳𝟱)*\n\n"
                "𝗣𝗹𝗲𝗮𝘀𝗲 𝘀𝗲𝗻𝗱 $𝟳𝟱 𝘁𝗼 𝗼𝗻𝗲 𝗼𝗳 𝘁𝗵𝗲𝘀𝗲 𝗮𝗱𝗱𝗿𝗲𝘀𝘀𝗲𝘀:\n\n"
                f"• *𝗕𝗶𝗻𝗮𝗻𝗰𝗲 𝗜𝗗:* `{self.payment_addresses['Binance ID']}`\n"
                f"• *𝗨𝗦𝗗𝗧 (𝗕𝗡𝗕 𝗦𝗺𝗮𝗿𝘁 𝗖𝗵𝗮𝗶𝗻):* `{self.payment_addresses['USDT (BNB Smart Chain)']}`\n"
                f"• *𝗟𝗧𝗖:* `{self.payment_addresses['LTC']}`\n"
                f"• *𝗕𝗧𝗖:* `{self.payment_addresses['BTC']}`\n\n"
    ...
    def run(self):
        ...
        print("\n💳 CREDIT PACKAGES:")
        print("- 100 credits = $10")
        print("- 500 credits = $40")
        print("- 1000 credits = $75")
        print("\n🎁 FREE CHECKS:")
        print("- First regular user gets 100 free card checks!")
        print("- Admins have UNLIMITED credits")
        print("\n💾 NEW FEATURES:")
